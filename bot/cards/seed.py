"""Seed data for card templates."""
from bot.cards.db import add_card_template


def seed_card_templates():
    """Populate card_templates table if empty. Safe to call multiple times (INSERT OR IGNORE)."""
    ...
    for name, hp, atk, spd, rarity, special in specials:
